export const INIT_HEADER_POST_CATEGORY_ACTION = 'header/init_header_post_category';
export const HEADER_MENU_ITEM_CLICK_ACTION = 'header/header_menu_item_click';
